...
$final_query = '%' . $query . '%';
$sql = "SELECT * FROM Board WHERE $type LIKE ? ORDER BY number $order";
...
<body>
    ...
    <ul class="board-list">
            ...
            <select id="array" onchange="location.href = 'board_search_list.php?order=' + this.value + '&type=' + currentType + '&query=' + currentQuery;">
